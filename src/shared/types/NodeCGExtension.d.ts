import type * as NodeCG from "nodecg/types";
import type { NodeCGMessages } from "./NodeCGMessages.js";
...
export interface ExtendedServerAPI<T extends Record<string, any>> extends NodeCG.default.ServerAPI<T> {
	listenFor<E extends keyof NodeCGMessages>(
		...
		bundleName: string,
		handlerFunc: (data: unknown, ack?: NodeCG.default.Acknowledgement) => void,
	): void;
	listenFor<E extends keyof NodeCGMessages>(
		messageName: E,
		handlerFunc: (data: NodeCGMessages[E], ack?: NodeCG.default.Acknowledgement) => void,
	): void;
...
export interface ExtendedClientAPI<T extends Record<string, any>> extends NodeCG.default.ClientAPI<T> {
