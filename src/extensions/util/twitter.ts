...
const streamParameters = ["expansions=author_id", "user.fields=username", "tweet.fields=created_at"];

const twitterSearch = ["expansions=author_id", "user.fields=username", "tweet.fields=created_at", "query=%23ASGX2023"];
